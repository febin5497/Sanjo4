            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-4xl font-bold flex items-center gap-3" style={{color: '#0052CC'}}>
                        <FaBox style={{color: '#0052CC'}} /> Materials Inventory
                    </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="status-card-blue-white bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform" style={{borderLeftColor: '#0052CC'}}>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-semibold uppercase" style={{color: '#0052CC'}}>Total Materials</p>
                ...
                <div className="status-card-blue-white bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform" style={{borderLeftColor: '#0052CC'}}>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-semibold uppercase" style={{color: '#0052CC'}}>Total Quantity</p>
                ...
                <div className="status-card-blue-white bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform" style={{borderLeftColor: '#0052CC'}}>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-semibold uppercase" style={{color: '#0052CC'}}>Low Stock Items</p>
