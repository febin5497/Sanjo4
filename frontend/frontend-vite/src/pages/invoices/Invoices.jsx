    ...
    return (
        <div style={{background: 'linear-gradient(135deg, #f0f5ff 0%, #e8f0fe 100%)', minHeight: '100vh', padding: '24px'}}>
            ...
            <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                <div>
                    <h1 className="text-3xl font-bold flex items-center gap-2" style={{color: '#0052CC'}}>
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 text-white rounded-lg font-semibold transition-all shadow-lg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white rounded-lg shadow-lg p-4 border-l-4 transform hover:shadow-xl transition-shadow" style={{ borderLeftColor: '#0052CC' }}>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-4xl opacity-30" style={{ color: '#0052CC' }}>
                            <FaFileInvoiceDollar />
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4">
                <h2 className="text-lg font-bold mb-3" style={{ color: '#0052CC' }}>
                    Invoice List ({filteredInvoices.length})
                </h2>
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead>
                            <tr style={{backgroundColor: '#f0f5ff', borderBottom: '2px solid #0052CC'}}>
                                <th className="text-left py-2 px-3 font-semibold text-sm" style={{color: '#0052CC'}}>Invoice ID</th>
                                <th className="text-left py-2 px-3 font-semibold text-sm" style={{color: '#0052CC'}}>Customer</th>
                                <th className="text-center py-2 px-3 font-semibold text-sm" style={{color: '#0052CC'}}>Date</th>
                                <th className="text-right py-2 px-3 font-semibold text-sm" style={{color: '#0052CC'}}>Amount</th>
                                <th className="text-center py-2 px-3 font-semibold text-sm" style={{color: '#0052CC'}}>Items</th>
                                <th className="text-center py-2 px-3 font-semibold text-sm" style={{color: '#0052CC'}}>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {filteredInvoices.length === 0 ? (
                                ...
                                filteredInvoices.map((invoice) => (
                                    <tr key={invoice.id} className="border-b text-sm" style={{backgroundColor: 'white'}} onMouseEnter={(e) => e.target.style.backgroundColor = '#f0f5ff'} onMouseLeave={(e) => e.target.style.backgroundColor = 'white'}>
            ...
            {showCreateModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
                    <div className="bg-white rounded-lg shadow-2xl w-full max-w-4xl h-auto max-h-[85vh]">
                        <div className="p-6 text-white" style={{ backgroundColor: '#0052CC' }}>
                        ...
                        <form onSubmit={handleCreateInvoice} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                            ...
                            <div className="border-t pt-4">
                                ...
                                <div className="mt-3 pt-3 border-t">
                                    <div className="space-y-1 text-sm">
                                        ...
                                        <div className="flex justify-between border-t pt-1 mt-1 text-base font-bold" style={{ color: '#0052CC' }}>
                            ...
                            <div className="flex gap-3 pt-4 border-t">
                                <button
                                    ...
                                    className="flex-1 py-2 px-4 text-white font-semibold rounded-lg hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
