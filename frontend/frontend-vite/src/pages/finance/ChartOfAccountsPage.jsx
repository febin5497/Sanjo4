...
const ChartOfAccountsPage = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen" style={{ background: 'linear-gradient(135deg, #f0f5ff 0%, #e8f0fe 100%)' }}>
        <div style={{ color: '#64748b' }}>Loading chart of accounts...</div>
      </div>
    );
  }
  return (
    <div className="p-6 max-w-6xl mx-auto min-h-screen" style={{ background: 'linear-gradient(135deg, #f0f5ff 0%, #e8f0fe 100%)' }}>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold" style={{ color: '#0052CC' }}>Chart of Accounts</h1>
          <p style={{ color: '#64748b' }} className="mt-1">Manage your accounting hierarchy</p>
        </div>
        <button
      ...
      <div className="mb-4 flex gap-2">
        <button
          ...
          style={{ backgroundColor: viewMode === 'tree' ? '#0052CC' : '#e2e8f0', color: viewMode === 'tree' ? 'white' : '#1e293b' }}
        >
          Tree View
        </button>
        <button
          ...
          className="px-4 py-2 rounded transition text-sm"
          style={{ backgroundColor: viewMode === 'list' ? '#0052CC' : '#e2e8f0', color: viewMode === 'list' ? 'white' : '#1e293b' }}
        >
          List View
        </button>
      </div>
