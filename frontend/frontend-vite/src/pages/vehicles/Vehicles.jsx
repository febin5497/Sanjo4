    ...
    return (
        <div className="p-6 md:p-6 sm:p-4 theme-blue-white min-h-screen">
            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-4xl font-bold flex items-center gap-3" style={{color: '#0052CC'}}>
                        <FaTruck style={{color: '#0052CC'}} /> Fleet Management
                    </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="status-card-blue-white bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform" style={{borderLeftColor: '#0052CC'}}>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-semibold uppercase" style={{color: '#0052CC'}}>Total Vehicles</p>
                            <p className="text-3xl font-bold mt-2" style={{color: '#0052CC'}}>{vehicles.length}</p>
                        </div>
                        <div className="text-5xl opacity-20" style={{color: '#0052CC'}}>
                            <FaTruck />
                        </div>
                    </div>
                </div>
                <div className="status-card-blue-white bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform" style={{borderLeftColor: '#0052CC'}}>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-semibold uppercase" style={{color: '#0052CC'}}>Active Vehicles</p>
                            <p className="text-3xl font-bold mt-2" style={{color: '#0052CC'}}>{activeCount}</p>
                        </div>
                        <div className="text-5xl opacity-20" style={{color: '#0052CC'}}>
                            ✓
                        </div>
                ...
                <div className="status-card-blue-white bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform" style={{borderLeftColor: '#0052CC'}}>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-semibold uppercase" style={{color: '#0052CC'}}>In Maintenance</p>
                            <p className="text-3xl font-bold mt-2" style={{color: '#0052CC'}}>{maintenanceCount}</p>
                        </div>
                        <div className="text-5xl opacity-20" style={{color: '#0052CC'}}>
                            ⚙️
                        </div>
                                        ...
                                        <td className="py-3 px-4 text-center">
                                            <div className="flex gap-2 justify-center">
                                                <button
                                                    ...
                                                    style={{backgroundColor: '#f0f5ff', color: '#0052CC', border: '1px solid #0052CC'}}
                                                    onMouseEnter={(e) => e.target.style.backgroundColor = '#e8f0fe'}
                                                    onMouseLeave={(e) => e.target.style.backgroundColor = '#f0f5ff'}
